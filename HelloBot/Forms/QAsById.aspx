<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QAsById.aspx.cs" Inherits="HelloBot.Forms.QAsById" %>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="active"><a href="Template.aspx"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> QAs</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">QAs</div>
                <div id="demo">
